...
public class Pantalla extends javax.swing.JFrame {
    ...
    private void btn_SumarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_SumarActionPerformed
        ...
        Principal operator1 = new Principal();
        
        operator1.resta(num1, num2);

        resultResta.setText(String.valueOf(operator1.restResult));

        Principal operator2 = new Principal();
        
        operator2.div(num1, num2);
        
        resultDiv.setText(String.valueOf(operator2.divResult));

        Principal operator3 = new Principal();
        
        operator3.multiplicacion(num1, num2);
        
        resultMulti.setText(String.valueOf(operator3.mulResult));
